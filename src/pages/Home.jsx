    ...
    <div className="page text-text selection:bg-accent/30 selection:text-accent"
      ...
      <section className="relative flex min-h-[calc(100vh-64px)] items-center overflow-hidden">
        ...
        <div className="container relative z-10 py-16 text-center">
          ...
          <div className="fade-up-3 mx-auto mb-10 max-w-3xl">
            <div className="flex items-center rounded-2xl border border-border2 bg-bg2 shadow-lg shadow-black/5 backdrop-blur-sm transition-all focus-within:border-accent focus-within:shadow-accent/10 focus-within:shadow-xl">
      ...
      {user && !isEducator && hasEnrolledSubjects ? (
        ...
        <div className="container">
          ...
          {loading ? (
            <div className="w-full flex items-center justify-center min-h-[60vh]"><div className="w-8 h-8 rounded-full border-2 border-accent border-t-transparent animate-spin"/></div>
          ) : categories.length > 0 ? (
            <>
